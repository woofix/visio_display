...
- The bootstrap creates missing `SECRET_KEY`, `POSTGRES_PASSWORD`, `DISPLAY_API_TOKEN` and `CLIENT_HEARTBEAT_TOKEN`, applies `chmod 600` to `.env`, creates `PRIVATE_DIR/backups`, and applies `chmod 700` to private data and backup directories.
