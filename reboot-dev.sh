...
usage() {
  cat <<'EOF'
Usage: ./reboot-dev.sh [version-ou-tag]

Met a jour Visio depuis la branche dev du depot Git, reconstruit les images
Docker, puis redemarre la stack Docker Compose.
...
log "Termine"
printf 'Visio est mis a jour depuis dev et redemarre.\n'
